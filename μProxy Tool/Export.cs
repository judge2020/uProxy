...
namespace μProxy_Tool
{
	...
	[OptionText, DesignerGenerated]
	public partial class Export : Form
	{
		// Token: 0x06000048 RID: 72 RVA: 0x0017102C File Offset: 0x0016F42C
		public Export()
		{
			base.Load += new EventHandler(this.Export_Load);
		...
		private void Button1_Click(object sender, EventArgs e)
		{
			checked
			{
					...
					try
					{
						...
						while (enumerator.MoveNext())
						{
							...
							if (this.@bool[2] && Operators.CompareString(listViewItem.SubItems[3].Text, "Transparent", true) == 0)
							{
								...
								{
									int arg_396_0 = 0;
									int num3 = this.CheckedListBox1.Items.Count - 1;
									for (int k = arg_396_0; k <= num3; k++)
									{
				...
				catch (Exception expr_4D8)
				{
					ProjectData.SetProjectError(expr_4D8);
					ProjectData.ClearProjectError();
				}
			}
		}

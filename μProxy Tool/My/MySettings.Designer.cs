...
namespace μProxy_Tool.My
{
	...
	[OptionText, CompilerGenerated, GeneratedCode("Microsoft.VisualStudio.Editors.SettingsDesigner.SettingsSingleFileGenerator", "12.0.0.0"), EditorBrowsable(EditorBrowsableState.Advanced)]
	public sealed partial class MySettings : ApplicationSettingsBase
	{
		...
		[DefaultSettingValue("50"), DebuggerNonUserCode, UserScopedSetting]
		public int Threads
		{
			get
			{
		...
		[DefaultSettingValue("10"), DebuggerNonUserCode, UserScopedSetting]
		public int Timeout
		{
			get
			{
		...
		[DebuggerNonUserCode, DefaultSettingValue("http://azenv.net"), UserScopedSetting]
		...
		[DebuggerNonUserCode, DefaultSettingValue("https://www.google.com/"), UserScopedSetting]
